...
URL = "https://apitotvsmoda.bhan.com.br/api/totvsmoda/financial-panel/v2/average-receipt-period/search"
...
# === CORPO DA REQUISIÇÃO ===
payload = {
    "branchs": [5],  # 🔹 Informe os códigos das empresas desejadas
    "datemin": "2025-09-01T00:00:00Z",
    "datemax": "2025-09-30T23:59:59Z"
}

print("🚀 Iniciando consulta de Período Médio de Recebimento (Painel Financeiro)...")
...
# === SALVA DEBUG JSON ===
debug_file = f"debug_average_receipt_period_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
...
excel_file = f"average_receipt_period_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
try:
